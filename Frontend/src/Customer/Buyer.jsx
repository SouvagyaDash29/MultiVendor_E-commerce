  ...
  const [cart, setCart] = useState([]);
    ...
    useEffect(() => {
      const fetchData = async () => {
        ...
        const electronicsResults = await getResults(2); // Fetch electronics products
        const watchResults = await getResults(3); // Fetch watch products
     ...
     <body >
        <Header cart={cart}/>
         ...
         <Routes >
          ...
          <Route path="/HomeApplience" element={<Applience />}/>
